...
function createMCPServer(sseSessionId: string) {
    ...
    server.setRequestHandler(ListToolsRequestSchema, async () => ({
        tools: [
            ...
            { name: "wallet_createAccount", description: "Create a new wallet account", inputSchema: { type: "object", properties: { name: { type: "string" } }, required: ["name"] } },
            { name: "wallet_importAccount", description: "Import a wallet account from private key", inputSchema: { type: "object", properties: { name: { type: "string" }, privateKey: { type: "string" } }, required: ["name", "privateKey"] } },
